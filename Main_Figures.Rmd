...
ggsave("~/Flanks/Images/f2pA.svg", plot = p1, height = 3, width = 8.7, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f2pB.svg", plot = p1, height = 10.5, width = 8.7, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f2pC.svg", plot = p1, height = 3, width = 8.7, units = "cm", dev = svglite)
...
ggsave("~/Flanks/Images/f3pB.svg", plot = F3B, height = 5, width = 5, units = "cm", dev = svglite)
...
ggsave("~/Flanks/Images/f3pC_1.svg", plot = p1, height = 4.5, width = 8.7, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f3pC_2.svg", plot = pp, height = 3, width = 8.7, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f3pD.svg", F3D, width = 8.7, height = 4.5, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f4pA.svg", F4A, width = 10, height = 6, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f4pB.svg", F4B, width = 10, height = 6, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f4pD.svg", plot = F4D, height = 5, width = 17, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f5pA.svg", plot = F5A, height = 5, width = 8.7, units = "cm", dev = svglite)
```
...
ggsave("~/Flanks/Images/f5pB.png", plot = f5pB, height = 15, width = 15, units = "cm", dpi = 600)
ggsave("~/Flanks/Images/f5pB.svg", plot = f5pB, height = 15, width = 15, units = "cm", dpi = 600, dev = svglite)
```
