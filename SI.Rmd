...
ggsave("images/S2.png",S2, height = 5, width = 10, units = "cm")
ggsave("images/S2.eps",S2, height = 5, width = 10, units = "cm")
```
...
ggsave("images/S4.png", S4, height = 5, width = 7, units = "cm")
ggsave("images/S4.eps", S4, height = 5, width = 7, units = "cm")
```
...
ggsave("images/S6A.png", plot = S6A, height = 17, width = 13, units = "cm")
ggsave("images/S6A.eps", plot = S6A, height = 17, width = 13, units = "cm")
...
ggsave("images/S6B.png", plot = S6B, height = 17, width = 13, units = "cm")
ggsave("images/S6B.eps", plot = S6B, height = 17, width = 13, units = "cm")
```
...
ggsave("images/S7.png", plot = S7, height = 4.5, width = 8.7, units = "cm")
ggsave("images/S7.eps", plot = S7, height = 4.5, width = 8.7, units = "cm")
...
ggsave("images/S8.png", plot = S8, height = 10, width = 10, units = "cm")
ggsave("images/S8.eps", plot = S8, height = 10, width = 10, units = "cm")
```
...
ggsave("images/S10.png", plot = S10, height = 5, width = 5, units = "cm")
ggsave("images/S10.eps", plot = S10, height = 5, width = 5, units = "cm")
```
...
ggsave("images/S11.png", plot = S11, height = 7, width = 7, units = "cm")
ggsave("images/S11.eps", plot = S11, height = 7, width = 7, units = "cm")
```
...
ggsave("images/S12.png", plot = S12, height = 10, width = 10, units = "cm")  
ggsave("images/S12.eps", plot = S12, height = 10, width = 10, units = "cm") 
...
ggsave("images/S13.png", plot = S13, height = 12, width = 8, units = "cm") 
ggsave("images/S13.eps", plot = S13, height = 12, width = 8, units = "cm") 
```
...
ggsave("images/S14.png", plot = S14, height = 5, width = 8, units = "cm")
ggsave("images/S14.eps", plot = S14, height = 5, width = 8, units = "cm")
```
...
ggsave("images/S15.png", plot = S15, height = 8, width = 15, units = "cm", dpi = 300)
```
...
ggsave("images/S16.png", plot = S16, height = 15, width = 15, units = "cm", dpi = 600)
ggsave("images/S16.eps", plot = S16, height = 15, width = 15, units = "cm", dpi = 600)
```
...
ggsave("images/S17.png", plot = S17, height = 10, width = 11.5, units = "cm")
ggsave("images/S17.eps", plot = S17, height = 10, width = 11.5, units = "cm")
