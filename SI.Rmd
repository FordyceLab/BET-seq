...
ggsave("~/Flanks/Images/S14.png", plot = S14, height = 15, width = 15, units = "cm")  
```
...
ggsave("~/Flanks/Images/S15.png", plot = S15, height = 15, width = 15, units = "cm", dpi = 600)
```
...
## Figure S18: Pho4 transcription rate and induction
```{r}
rateVal = 
...
S18 = cowplot::plot_grid(p1,p2,nrow=1,scale = c(1,1))

ggsave("~/Flanks/Images/S18.png", plot = S18, height = 5, width = 8, units = "cm")
```
